import { GraphQLSchema, GraphQLObjectType, GraphQLFieldMap, isObjectType } from 'graphql'

export const validateAlphabeticalOrder = (schema: GraphQLSchema, errors: string[]) => {
...
const validateTypeAlphabeticalOrder = (type: GraphQLObjectType, errors: string[]) => {
